...
public class SegnalazionePanel extends JPanel{
    ...
    public SegnalazionePanel(){
        ...
        submitButton = new JButton("INVIA",new ImageIcon(getClass().getResource("/Grafica/immagini/buttonNormal.png")));
    ...
    public void creaBottoneConferma(JButton b){
        ...
        b.setRolloverIcon(new ImageIcon(this.getClass().getResource("/Grafica/immagini/buttonHover.png")));
        b.setPressedIcon(new ImageIcon(this.getClass().getResource("/Grafica/immagini/buttonPressed.png")));
