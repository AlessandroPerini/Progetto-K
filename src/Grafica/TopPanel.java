...
import Ascoltatori.Header.Back;
import Ascoltatori.Header.Menù;
...
public class TopPanel extends JPanel{
    ...
    public TopPanel(String t) {
        ...
        backButton = new JButton(new ImageIcon(getClass().getResource("/Grafica/immagini/buttonNormal.png")));
        title = new JLabel(t);
    ...
    public void creaPannello(){
        ...
        backButton.setRolloverIcon(new ImageIcon(getClass().getResource("/Grafica/immagini/buttonHover.png")));
        backButton.setPressedIcon(new ImageIcon(getClass().getResource("/Grafica/immagini/buttonPressed.png")));
