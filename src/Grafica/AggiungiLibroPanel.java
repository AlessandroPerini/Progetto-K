...
import Ascoltatori.Libri.AggiungiLibro;
...
public class AggiungiLibroPanel extends JPanel{
    ...
    public AggiungiLibroPanel() {
        ...
        euro = new JLabel("€");
        aggiungi = new JButton(new ImageIcon(getClass().getResource("/Grafica/immagini/buttonNormal.png")));
    ...
    public void creaPannelloBottone(){
        ...
        aggiungi.setRolloverIcon(new ImageIcon(getClass().getResource("/Grafica/immagini/buttonHover.png")));
        aggiungi.setPressedIcon(new ImageIcon(getClass().getResource("/Grafica/immagini/buttonPressed.png")));
