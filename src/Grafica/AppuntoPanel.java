...
public class AppuntoPanel extends JPanel{
    ...
    public AppuntoPanel() {
        ...
        //dichiarazione icone
        scaricaNormal = new ImageIcon(this.getClass().getResource("/Grafica/immagini/buttonNormal.png"));
        ocrNormal = new ImageIcon(this.getClass().getResource("/Grafica/immagini/buttonNormal.png"));
        scaricaHover = new ImageIcon(this.getClass().getResource("/Grafica/immagini/buttonHover.png"));
        scaricaPressed = new ImageIcon(this.getClass().getResource("/Grafica/immagini/buttonPressed.png"));
