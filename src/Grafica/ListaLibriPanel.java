...
import Ascoltatori.Libri.GoToAggiungiLibro;
import Ascoltatori.Libri.CercaLibri;
...
public class ListaLibriPanel extends JPanel{
    ...
    public ListaLibriPanel() {
        ...
        searchButton = new JButton(new ImageIcon(getClass().getResource("/Grafica/immagini/buttonNormal.png")));
        clearSearch = new JButton("", new ImageIcon(getClass().getResource("/Grafica/immagini/clear.png")));
        addLibro = new JButton("", new ImageIcon(getClass().getResource("/Grafica/immagini/add.png")));
    ...
    public void creaPannelloRicerca(){
        ...
        searchButton.setRolloverIcon(new ImageIcon(getClass().getResource("/Grafica/immagini/buttonHover.png")));
        searchButton.setPressedIcon(new ImageIcon(getClass().getResource("/Grafica/immagini/buttonPressed.png")));
    ...
    public void creaPannelloOrdina(){
        ...
        addLibro.setRolloverIcon(new ImageIcon(getClass().getResource("/Grafica/immagini/addHover.png")));
        addLibro.setPressedIcon(new ImageIcon(getClass().getResource("/Grafica/immagini/addPressed.png")));
    ...
    public void creaPannelloLista(){
        ...
        if(nLibri == 0){
            ...
            for (int i = 0; i < applicazione.listaLibriAttuali.size(); i++) {
                ...
                libriIcon[i] = new JLabel(new ImageIcon(this.getClass().getResource("/Grafica/immagini/dotLibro.png")));
