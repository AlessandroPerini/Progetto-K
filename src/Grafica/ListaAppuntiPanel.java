...
import Ascoltatori.Appunti.GoToAggiungiAppunto;
import Ascoltatori.Appunti.CercaAppunti;
...
public class ListaAppuntiPanel extends JPanel{
    ...
    public ListaAppuntiPanel() {
        ...
        search = new ImageIcon(this.getClass().getResource("/Grafica/immagini/buttonNormal.png"));
        searchHover = new ImageIcon(this.getClass().getResource("/Grafica/immagini/buttonHover.png"));
        searchPressed = new ImageIcon(this.getClass().getResource("/Grafica/immagini/buttonPressed.png"));
        add = new ImageIcon(this.getClass().getResource("/Grafica/immagini/add.png"));
        addHover = new ImageIcon(this.getClass().getResource("/Grafica/immagini/addHover.png"));
        addPressed = new ImageIcon(this.getClass().getResource("/Grafica/immagini/addPressed.png"));
        clear = new ImageIcon(this.getClass().getResource("/Grafica/immagini/clear.png"));
    ...
    public void creaPannelloLista(){
        ...
        if(size == 0){
            ...
            for (int i = 0; i < applicazione.listaAppuntiAttuali.size(); i++) {
                ...
                appuntiIcon[i] = new JLabel(new ImageIcon(this.getClass().getResource("/Grafica/immagini/dotAppunto.png")));
                ...
                if((media==0)){
                    ...
                    appuntiIcoValutazione[i] = new JLabel(new ImageIcon(this.getClass().getResource("/Grafica/immagini/0-star-rating.png")));
                    
                }
                if((media>0)&&(media<=1)){
                    
                    appuntiIcoValutazione[i] = new JLabel(new ImageIcon(this.getClass().getResource("/Grafica/immagini/1-star-rating.png")));
                    
                }
                if((media>1)&&(media<=2)){
                    
                    appuntiIcoValutazione[i] = new JLabel(new ImageIcon(this.getClass().getResource("/Grafica/immagini/2-star-rating.png")));
                    
                }
                if((media>2)&&(media<=3)){
                    
                    appuntiIcoValutazione[i] = new JLabel(new ImageIcon(this.getClass().getResource("/Grafica/immagini/3-star-rating.png")));
                    
                }
                if((media>3)&&(media<=4)){
                    
                    appuntiIcoValutazione[i] = new JLabel(new ImageIcon(this.getClass().getResource("/Grafica/immagini/4-star-rating.png")));
                    
                }
                if(media>4){
                    
                    appuntiIcoValutazione[i] = new JLabel(new ImageIcon(this.getClass().getResource("/Grafica/immagini/5-star-rating.png")));
