...
class scrollBarLayout extends MetalScrollBarUI {
    ...
    public scrollBarLayout () {
        imageThumb = new ImageIcon(this.getClass().getResource("/Grafica/immagini/barThumb.png"));
        imageTrack = new ImageIcon(this.getClass().getResource("/Grafica/immagini/barTrack.png"));
    }
