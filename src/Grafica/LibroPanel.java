...
import Ascoltatori.Libri.EliminaLibro;
import Ascoltatori.Preferiti.AggiungiLibroPreferito;
import Ascoltatori.Preferiti.RimuoviLibroPreferito;
...
public class LibroPanel extends JPanel{
    ...
    public LibroPanel() {
        ...
        elimina = new JButton(new ImageIcon(getClass().getResource("/Grafica/immagini/deleteNormal.png")));
    ...
    public void creaButtoneElimina(){
        ...
        elimina.setRolloverIcon(new ImageIcon(getClass().getResource("/Grafica/immagini/deleteHover.png")));
        elimina.setPressedIcon(new ImageIcon(getClass().getResource("/Grafica/immagini/deletePressed.png")));
