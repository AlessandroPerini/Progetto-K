...
import Ascoltatori.QeA.EliminaDomanda;
import Ascoltatori.QeA.AggiungiRisposta;
import Database.InfoQuery;
import Database.ControlloQuery;
import Ascoltatori.Preferiti.AggiungiDomandaPreferita;
import Ascoltatori.Preferiti.RimuoviDomandaPreferita;
import Ascoltatori.QeA.AggiungiLikeDomanda;
import Ascoltatori.QeA.AggiungiLikeRisposta;
...
public class DomandaPanel extends JPanel{
    ...
    public DomandaPanel() {
        ...
        rispondiNormal = new ImageIcon(this.getClass().getResource("/Grafica/immagini/buttonNormal.png"));
        rispondiPressed = new ImageIcon(this.getClass().getResource("/Grafica/immagini/buttonPressed.png"));
        rispondiHover = new ImageIcon(this.getClass().getResource("/Grafica/immagini/buttonHover.png"));
        eliminaNormal = new ImageIcon(this.getClass().getResource("/Grafica/immagini/deleteNormal.png"));
        eliminaHover = new ImageIcon(this.getClass().getResource("/Grafica/immagini/deleteHover.png"));
        eliminaPressed = new ImageIcon(this.getClass().getResource("/Grafica/immagini/deletePressed.png"));
        ...
        likeDomanda = new JButton(new ImageIcon(this.getClass().getResource("/Grafica/immagini/thumbup.png")));
    ...
    public void creaPannelloLikeRisposta(){
        ...
        try {
            if(!ControlloQuery.controlloLikeDomanda()){
                likeDomanda.setIcon(new ImageIcon(this.getClass().getResource("/Grafica/immagini/thumbupON.png")));
            }
        } catch (SQLException ex) {
        ...
        try {
            ...
            try {
                ...
                if(valoreLike==0){
                    ...
                    likeRisposta.setIcon(new ImageIcon(this.getClass().getResource("/Grafica/immagini/thumbup.png")));
                }else{
                    if(valoreLike==1){
                        
                        likeRisposta.setIcon(new ImageIcon(this.getClass().getResource("/Grafica/immagini/thumbupON.png")));
                    }else{
            ...
            try {
                ...
                if(valoreLike==0){
                    dislikeRisposta.setIcon(new ImageIcon(this.getClass().getResource("/Grafica/immagini/thumbdown.png")));
                }else{
                    if(valoreLike==1){
                        dislikeRisposta.setIcon(new ImageIcon(this.getClass().getResource("/Grafica/immagini/thumbdown.png")));
                    }else{
                        dislikeRisposta.setIcon(new ImageIcon(this.getClass().getResource("/Grafica/immagini/thumbdownON.png")));
                    }
