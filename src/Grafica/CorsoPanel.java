...
public class CorsoPanel extends JPanel{
    ...
    public void creaOggetti(){
        ...
        appunti = new JButton(new ImageIcon(getClass().getResource("/Grafica/immagini/appunti.png")));
        ...
        libri = new JButton(new ImageIcon(getClass().getResource("/Grafica/immagini/libri.png")));
        ...
        qea = new JButton(new ImageIcon(getClass().getResource("/Grafica/immagini/qea.png")));
