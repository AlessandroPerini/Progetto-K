...
import Ascoltatori.Login.DoLogin;
import Ascoltatori.Facolta.CaricaFacoltà;
import java.awt.*;
import javax.swing.*;
...
public class LoginPanel extends JPanel{
    ...
    public LoginPanel(){
        ...
        bottoneNormal = new ImageIcon(this.getClass().getResource("/Grafica/immagini/buttonNormal.png"));
        bottoneHover = new ImageIcon(this.getClass().getResource("/Grafica/immagini/buttonHover.png"));
        bottonePressed = new ImageIcon(this.getClass().getResource("/Grafica/immagini/buttonPressed.png"));
        
        //inizializzazione oggetti
        title = new JLabel(new ImageIcon(getClass().getResource("/Grafica/immagini/titolo.png")));
        ...
        img = new JLabel(new ImageIcon(this.getClass().getResource("/Grafica/immagini/loginIcon.png")),JLabel.RIGHT);
