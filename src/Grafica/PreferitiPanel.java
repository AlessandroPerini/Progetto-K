...
public class PreferitiPanel extends JPanel{
    ...
    public PreferitiPanel() {
        ...
        search = new ImageIcon(getClass().getResource("/Grafica/immagini/button2Normal.png"));
        searchHover = new ImageIcon(getClass().getResource("/Grafica/immagini/button2Hover.png"));
        searchPressed = new ImageIcon(getClass().getResource("/Grafica/immagini/button2Pressed.png"));
        searchSelected = new ImageIcon(getClass().getResource("/Grafica/immagini/button2Selected.png"));
    ...
    public void creaPannelloFacoltàPreferite(){
        ...
        if(dimFacoltàPreferite == 0){
            ...
            for (int i = 0; i < dimFacoltàPreferite; i++) {
                ...
                facoltàPreferiteIco[i] = new JLabel(new ImageIcon(getClass().getResource("/Grafica/immagini/dotFacoltà.png")));
    ...
    public void creaPannelloCorsiPreferiti(){
        ...
        if(dimCorsiPreferiti == 0){
            ...
            for (int i = 0; i < dimCorsiPreferiti; i++) {
                ...
                corsiPreferitiIco[i] = new JLabel(new ImageIcon(getClass().getResource("/Grafica/immagini/dotCorso.png")));
    ...
    public void creaPannelloAppuntiPreferiti(){
        ...
        if(dimAppuntiPreferiti == 0){
            ...
            for (int i = 0; i < dimAppuntiPreferiti; i++) {
                ...
                appuntiPreferitiIco[i] = new JLabel(new ImageIcon(getClass().getResource("/Grafica/immagini/dotAppunto.png")));
    ...
    public void creaPannelloLibriPreferiti(){
        ...
        if(dimLibriPreferiti == 0){
            ...
            for (int i = 0; i < dimLibriPreferiti; i++) {
                ...
                libriPreferitiIco[i] = new JLabel(new ImageIcon(getClass().getResource("/Grafica/immagini/dotLibro.png")));
    ...
    public void creaPannelloDomandePreferite(){
        ...
        if(dimDomandePreferite == 0){
            ...
            for (int i = 0; i < dimDomandePreferite; i++) {
                ...
                domandePreferiteIco[i] = new JLabel(new ImageIcon(getClass().getResource("/Grafica/immagini/dotDomanda.png")));
