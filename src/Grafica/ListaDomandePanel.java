...
import Ascoltatori.QeA.GoToAggiungiDomanda;
import Ascoltatori.QeA.GoToDomanda;
import Ascoltatori.QeA.CercaDomande;
...
public class ListaDomandePanel extends JPanel{
    ...
    public ListaDomandePanel() {
        ...
        clearSearch = new JButton("", new ImageIcon(this.getClass().getResource("/Grafica/immagini/clear.png")));
        ordina = new JComboBox<>(opzioni);
        ordinamento = new JLabel("Ordina per :");
        addDomanda = new JButton( new ImageIcon(this.getClass().getResource("/Grafica/immagini/add.png")));
    ...
    public void creaPannelloOrdina(){
        ...
        addDomanda.setRolloverIcon(new ImageIcon(getClass().getResource("/Grafica/immagini/addHover.png")));
        addDomanda.setPressedIcon(new ImageIcon(getClass().getResource("/Grafica/immagini/addPressed.png")));
    ...
    public void creaPannelloLista(){
        ...
        if(size == 0){
            ...
            for (int i = 0; i < applicazione.listaDomandeAttuali.size(); i++) {
                ...
                domandeIcon[i] = new JLabel(new ImageIcon(this.getClass().getResource("/Grafica/immagini/dotDomanda.png")));
                ...
                domandeIcon[i] = new JLabel(new ImageIcon(this.getClass().getResource("/Grafica/immagini/thumbupList.png")), HEIGHT);
                gbcImg.gridx = 2;
                gbcImg.gridy = i+1;
